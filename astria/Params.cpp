...
char CParams::SkyboxTop[64];
char CParams::SkyboxBot[64];
char CParams::SkyboxLeft[64];
char CParams::SkyboxRight[64];
char CParams::SkyboxFront[64];
char CParams::SkyboxBack[64];
...
bool CParams::Load(char* file)
{
	...
	inFile >> ParamDescription >> SkyboxLeft;
	inFile >> ParamDescription >> SkyboxRight;
	inFile >> ParamDescription >> SkyboxFront;
	inFile >> ParamDescription >> SkyboxBack;
